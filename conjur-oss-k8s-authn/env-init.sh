git clone https://github.com/diverdane/conjur-oss-k8s-authn-katacoda.git
#cd conjur-oss-k8s-authn-katacoda

#wget https://github.com/diverdane/conjur-oss-k8s-authn-katacoda/archive/v1.0.zip
#unzip v1.0.zip
...
#cp conjur-oss-k8s-authn-katacoda/test-app/test-app.yml conjur-oss-k8s-authn-katacoda-1.0/test-app/
#cp conjur-oss-k8s-authn-katacoda/test-app/test-app-conjur.yml conjur-oss-k8s-authn-katacoda-1.0/test-app/
#cp conjur-oss-k8s-authn-katacoda/test-app/pg/secretless-pg.yml conjur-oss-k8s-authn-katacoda-1.0/test-app/pg/
#cp conjur-oss-k8s-authn-katacoda/test-app/pg/postgres.yml conjur-oss-k8s-authn-katacoda-1.0/test-app/pg/
